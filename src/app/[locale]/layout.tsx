...
const SEO_CONTENT = {
  en: {
    ...
    description: (years: number) =>
      `Frontend and Full-Stack Developer with ${years}+ years of experience building reliable, scalable products with Next.js, React, Node.js, PostgreSQL, and Docker.`,
    locale: "en_US",
  },
  tr: {
    title: "Yasin Eryılmaz | Frontend & Full-Stack Geliştirici",
    description: (years: number) =>
      `Next.js, React, Node.js, PostgreSQL ve Docker ile güvenilir ve ölçeklenebilir ürünler geliştiren, ${years}+ yıl deneyimli Frontend ve Full-Stack geliştirici.`,
    locale: "tr_TR",
  },
} as const
...
export async function generateMetadata({
  ...
  const description = content.description(getYearsOfExperience())
